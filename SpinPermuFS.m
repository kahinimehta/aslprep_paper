...
outdir= '/Users/adebimpe/Documents/aslprep_paper/';
...
[verticesl, ~] = freesurfer_read_surf(fullfile('/Applications/freesurfer//subjects/fsaverage5/surf/lh.sphere'));
[verticesr, ~] = freesurfer_read_surf(fullfile('/Applications/freesurfer//subjects/fsaverage5/surf/rh.sphere'));
...
writematrix(bigrotl, [outdir, '/lhx_spin_test_','_output.csv']);
writematrix(bigrotr, [outdir, '/rhx_spin_test_','_output.csv']);
